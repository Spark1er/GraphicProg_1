...
namespace GrafLab1
{
    public partial class Form1 : Form
    {
        ...
        {
            var bm = new Bitmap(20, 20);
            bm.SetPixel(0, 0, Color.FromArgb(0, 255, 2));
            g.DrawImageUnscaled(bm, x, y);
        }
        ...
        {   //создаем переменную для управления графикой
            ...
            Bresenham4Line(g, Color.Red, pictureBox1.ClientSize.Width - pictureBox1.ClientSize.Width / 2, 0,
            ...
            // прямая линия(основание) - смысл тот же, только цвет уже мы указали в методе алгоритма ЦДА
